...
class ErrorCode(str, Enum):
    ...
    TELEGRAM_LINK_PERSON_REQUIRED = "TELEGRAM_LINK_PERSON_REQUIRED"
    ...
    NOTIFY_TRANSPORT_NOT_SUPPORTED = "NOTIFY_TRANSPORT_NOT_SUPPORTED"
    NOTIFY_TRANSPORT_REQUIRES_CLIENT = "NOTIFY_TRANSPORT_REQUIRES_CLIENT"
    WEBPUSH_CLIENT_INVALID = "WEBPUSH_CLIENT_INVALID"
    WEBPUSH_NOT_CONFIGURED = "WEBPUSH_NOT_CONFIGURED"
