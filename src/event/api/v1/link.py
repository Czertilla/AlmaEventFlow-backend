...
@router.get("/{link_id}", responses={**auth_responses(), **entity_not_found_responses("link")})
async def get_link(
...
@router.put("/{link_id}", responses={**auth_responses(), **entity_not_found_responses("link")})
async def put_link(
...
@router.patch("/{link_id}", responses={**auth_responses(), **entity_not_found_responses("link")})
...
@router.delete("/{link_id}", responses={**auth_responses(), **entity_not_found_responses("link")})
